...
public class ViewPurchase extends javax.swing.JFrame {
    ...
    public ViewPurchase(int id) {
        initComponents();
        
        db = Db.getObj();
        pModel = db.getPurchaseByID(id);
        setTableColumn();
        
        jComboBox2.addItem(pModel.getCompName());
        try{
            Date date = new SimpleDateFormat("yyyy-MM-dd").parse(pModel.getDate());
            jDateChooser1.setDate(date);
        }catch(Exception e){System.out.println("date exception");}
        
        addToTable(pModel.getPurchaseList());
    }
    ...
    private void addToTable(List<PurchaseItems>purList) {
        double grandTotal = 0;
        int i =1;
        for(PurchaseItems p:purList){
            ...
            String total = String.valueOf(p.getPrice()*p.getQty());
            
            
            String d[] = new String[]{String.valueOf(i),name,qty,price,total,id};
            dm.addRow(d);
