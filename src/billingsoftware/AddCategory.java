...
public class AddCategory extends javax.swing.JFrame {
    ...
    AddProducts ad;
    public AddCategory(AddProducts ad) {
        initComponents();
        jButton1.setText(SAVE);
        this.ad = ad;
    }
    ...
    String name,id;
    ViewCategory v;
    public AddCategory(ViewCategory v,String id,String name) {
        initComponents();
        this.id = id;
        this.name = name;
        this.v = v;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!jTextField1.getText().isEmpty()){
            if(jButton1.getText().equals(SAVE)){
                int i= db.insertIntoCategory(jTextField1.getText());
                
                Utils.showMessage(this, i);//showning message easily
                clearUI();
            }
            else{
                int i= db.updateCategory(jTextField1.getText(),id);
                v.init();
                Utils.showMessage(this, i);//showning message easily
                clearUI();
            }
