...
public class AddReturn extends javax.swing.JFrame {
    ...
    private void jTable2MouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseReleased
        ...
        if(dialogResult == JOptionPane.YES_OPTION){
            // Saving code here
            double total = Double.parseDouble(jTable2.getValueAt(index, 4).toString());
            dm.removeRow(index);

            double grandTotal = Double.parseDouble(jLabel19.getText());
            jLabel19.setText(grandTotal-total+"");
        }
            ...
            if(dm.getRowCount()>0){
                ...
                for(int i=0;i<s;i++){
                    data.add(new String[]{dm.getValueAt(i, 1).toString(),dm.getValueAt(i, 2).toString(),
                        ...
                        dm.getValueAt(i, 6).toString()});
                }

                //getting customer id
                int index = jComboBox2.getSelectedIndex();
                String da = invList.get(index-1);

                Db d = Db.getObj();
                int i = d.insertReturn(data, date,da);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddReturn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void setInvCombo() {
        jComboBox2.removeAllItems();//removing all items

        invList = db.getAllInv();
        int s = invList.size();
        jComboBox2.addItem("select");
        for(int i= 0;i<s;i++){
            jComboBox2.addItem(invList.get(i));
        }
        
    }

    private void setProCombo() {
    ...
    public boolean validation(){
        ...
        if(jComboBox2.getSelectedIndex() == 0){
            int dialogButton = JOptionPane.YES_NO_OPTION;
            int dialogResult = JOptionPane.showConfirmDialog (null, "Warning !",
                "Continue without Invoice id",dialogButton);
            if(dialogResult == JOptionPane.YES_OPTION){
                // Saving code here
                return true;
            }
